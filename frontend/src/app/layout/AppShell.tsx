 ...
 *           财务入口仅严格 finance 可见；人力入口（人员资质/团队推荐/人员业绩）仅严格 hr 可见；
...
/** P10D/P10F/P10H：人力入口，独立「人力」分组；仅严格 hr 可见 */
const hrNav: NavItem[] = [
  {
    to: "/hr",
    label: "人员资质",
  ...
  {
    to: "/hr/performance-cards",
    label: "人员业绩",
    icon: <Award size={18} />,
    matchPrefix: "/hr/performance-cards",
    hrOnly: true,
  },
];
...
function isNavActive(pathname: string, item: NavItem): boolean {
  ...
  // 人员资质仅精确匹配 /hr，避免与 /hr/team-recommendations、/hr/performance-cards 激活态冲突
  if (item.to === "/hr") {
    return pathname === "/hr";
  }
