...
const projectMap: Record<ProjectStatus, { label: string; className: string }> = {
  ...
  analyzing: { label: "分析中", className: "badge-primary" },
  writing: { label: "撰写中", className: "badge-primary" },
  reviewing: { label: "审校中", className: "badge-free" },
  exported: { label: "已导出", className: "badge-primary" },
};

const taskMap: Record<TaskStatus, { label: string; className: string }> = {
  pending: { label: "排队中", className: "badge-muted" },
  running: { label: "进行中", className: "badge-primary" },
  paused: { label: "已暂停", className: "badge-free" },
  success: { label: "已完成", className: "badge-primary" },
