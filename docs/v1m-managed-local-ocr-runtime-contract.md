...
> **状态：M1 automated/fake-runtime 已完成、验收并推送；M2 只读审计已完成，待冻结决策与精确白名单。M3/M4 未开始。**
> **基线：** 契约=`9ed3a06`，M1 测试=`3be6d19`/`3b8e42e`/`61dbe38`，生产=`a7d640b`；只允许 `collab/grok-code-codex-review`，严禁操作 `main`。
