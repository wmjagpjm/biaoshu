...
契约=`docs/p12h-checkpoint-delete-contract.md`，计划=`docs/plans/2026-07-19-p12h-checkpoint-delete-plan.md`；本次文档提交即冻结。严格七文件且不改模型、数据库、Schema、核心检查点/恢复服务、页面/hook、共享请求层或修订历史。
