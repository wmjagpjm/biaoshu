...
## P12F-J-B 修订固定状态七键响应与前端入口（已冻结，待实现）

契约=`docs/p12f-revision-pinning-frontend-contract.md`、计划=`docs/plans/2026-07-19-p12f-revision-pinning-frontend-plan.md`；冻结基线为 P12F-J-A 实现 `a7021c4`、文档闭环 `f030f89`。
