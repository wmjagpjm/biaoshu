...
## P12F-E-B 修订时间范围筛选前端（已审计，当前文档冻结）
...
Grok 必须先只改 E2E 形成真实红测，再实现两生产文件；聚焦、history、技术/商务 truth、checkpoint、lint/build 全部串行且显式 `--workers=1 --retries=0`。正文/标题搜索、来源多选、日期预设、自动加载、命名/固定/删除、跨项目历史、多人协作和后端变更均不在本包。
