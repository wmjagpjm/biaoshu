...
## P12F-I 修订名称与可见内容联合搜索（已审计，当前冻结）

契约=`docs/p12f-revision-display-name-search-contract.md`、计划=`docs/plans/2026-07-18-p12f-revision-display-name-search-plan.md`，冻结基线=`060191e`。严格四文件为 history search service、既有内容搜索专项、共用修订面板和 history E2E；不改路由、Schema、API 封装、模型、迁移、索引或依赖。
