...
## P12G 手动检查点展示名称（已冻结待实现）

契约=`docs/p12g-checkpoint-display-name-contract.md`，计划=`docs/plans/2026-07-19-p12g-checkpoint-display-name-plan.md`；本次文档提交即冻结。严格十二文件为检查点表增加 nullable `display_name`、独立单列 PATCH、create/list/detail 七/七/八键元数据，以及技术标/商务标共用面板原位命名入口。
