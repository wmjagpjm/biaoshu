...
9. P13-F1 无前端在线 UI、SSE/WebSocket、广播、光标、章节锁、历史或后台清理线程；P13-F2 已在下节独立冻结，不沿用本包白名单。
...
## P13-F2 项目近期成员前端（已冻结，待实现）

契约=`docs/p13f2-project-presence-frontend-contract.md`，计划=`docs/plans/2026-07-20-p13f2-project-presence-frontend-plan.md`，在途交接=`docs/HANDOFF-p13f2-in-progress.md`。完成后必须逐项验收：
...
当前只有设计与冻结证据，尚未下发 Grok、尚无 failure-first 或实现测试结果；禁止冒充已完成功能。
