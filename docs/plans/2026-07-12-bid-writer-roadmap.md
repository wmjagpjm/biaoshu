...
阶段 0/1/2/3 已完成并推送（M3-A=`5d37dba`，M3-B=`e2e5d04`）。阶段 4 **包 5** 已推送（`460097a`）；**包 6** 已推送（`1289c92`）；**包 7** 已推送（`2c7b3e0`）；**包 8** 调度 MVP=`6db1586`，后续 **P8B** 解析策略接线已完成（计划=`f662674`、后端=`0994cc8`、前端=`80d2579`；MinerU 仍仅外置 callback、Docling 未接）。阶段 5 的 P10A 身份/RBAC、P10B 财务报价只读投影、P10C 财务成本草案/毛利快照、P10D 人员资质素材卡、P10F 团队推荐快照、P10E 匿名合规汇总与 P10G 单项目合规统计均已完成。下一步如扩展财务税务/审批/导出、人员业绩/附件/证件校验、投标人矩阵明细/版本/结果跟踪，或真实解析器生产部署，必须先冻结新的独立数据契约，禁止沿用 P10C/P10D/P10E/P10F/P10G 路径顺带扩权。
