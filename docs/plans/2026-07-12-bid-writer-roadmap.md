...
财务、人力、投标人以及账号登录、角色权限、协作审批属于平台演进阶段。当前已受限交付 P10A 身份底座、P10B/P10C 财务、P10D 人力最小卡片、P10F 人力团队推荐快照和 P10E 投标人匿名汇总；任何新增角色能力仍须独立冻结数据、权限和审计边界，禁止绕过现有单 workspace 约束。
...
| 投标人 | P10E 已交付工作空间级匿名响应矩阵合规汇总；后续项目级预览、版本和结果跟踪 | 不改标书核心内容；不返回项目、原文、人员或财务数据；不以所有者身份绕过 strict `bidder` |
...
阶段 0/1/2/3 已完成并推送（M3-A=`5d37dba`，M3-B=`e2e5d04`）。阶段 4 **包 5** 已推送（`460097a`）；**包 6** 已推送（`1289c92`）；**包 7** 已推送（`2c7b3e0`）；**包 8** 调度 MVP=`6db1586`，后续 **P8B** 解析策略接线已完成（计划=`f662674`、后端=`0994cc8`、前端=`80d2579`；MinerU 仍仅外置 callback、Docling 未接）。阶段 5 的 P10A 身份/RBAC、P10B 财务报价只读投影、P10C 财务成本草案/毛利快照、P10D 人员资质素材卡、P10F 团队推荐快照与 P10E 匿名合规汇总均已完成。下一步如扩展财务税务/审批/导出、人员业绩/附件/证件校验、投标人项目级预览/版本/结果跟踪，或真实解析器生产部署，必须先冻结新的独立数据契约，禁止沿用 P10C/P10D/P10E/P10F 路径顺带扩权。
