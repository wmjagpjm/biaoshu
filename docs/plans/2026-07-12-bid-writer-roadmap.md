...
阶段 0/1/2 已完成；阶段 3 的 M3-A/M3-B/M3-C 已交付，下一最小包 M3-D 已冻结为“服务端原子确认 + 最近 20 批一次性漂移安全恢复”。必须先完成 M3-D 后端独立审查与提交，验收前不得派发前端。阶段 4 **包 5** 至 **包 8/P8B/P8C**、P9A/P9B/P9C/P9D 与阶段 5 P10A 至 P10K 均保持已交付；真实 MinerU/Docling 运行时、外部来源、完整财务审计、附件核验或生产部署能力不得搭车。
