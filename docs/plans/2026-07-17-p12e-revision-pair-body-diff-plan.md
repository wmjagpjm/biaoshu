...
全部独立验收通过后，Codex 更新 `docs/HANDOFF-next.md`、路线图、`docs/integration-checklist.md`、本契约和本计划，记录真实 failure-first 与全量计数；以中文提交信息提交并推送。实现边界继续明确：本包没有前端入口、分页、搜索、恢复、删除、导出、分享或多人协作。
